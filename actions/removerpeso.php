...
/**
 * Action responsavél pela exclusão do registro de peso
 * 
 * @package Default
...
$v_app_retorno  = [];
$v_peso_id      = ((isset($_POST['peso_excluir_id'])) ? $_POST['peso_excluir_id'] : '');
$fsessao        = new Session();
$v_session_code = ((isset($_SESSION['code'])) ? $_SESSION['code'] : ((isset($_COOKIE['code'])) ? $_COOKIE['code'] : ''));
if ($v_session_code !== '' && $v_peso_id !== '') {
    $fpeso  = new Peso();
    $v_peso = $fpeso->desativarPeso($v_peso_id, '0');
